...
class RegisterView(tk.Tk):
    def __init__(self, controller):
        ...
        self.rider_phone_number_label = ttk.Label(self.rider_frame, text="Rider Phone Number:")
        self.rider_phone_number_label.pack(pady=10)
        ...
        self.passenger_phone_number_label = ttk.Label(self.passenger_frame, text="Passenger Phone Number:")
        self.passenger_phone_number_label.pack(pady=10)
